...
function temporaryDirectory() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'rice-protected-paths-'));
}
...
async function main() {
  ...
  await runTest('the Rice hook protects writes while allowing reads unless read protection is configured', async () => {
